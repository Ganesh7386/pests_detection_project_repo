...
def snapshot_chunk_dataset(chunk_file, output_types, output_shapes, compression="", name=None):
  r"""TODO: add doc.
...
def snapshot_chunk_dataset_eager_fallback(chunk_file, output_types, output_shapes, compression, name, ctx):
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'snapshot_chunk_dataset' Op, not %r." % output_types)

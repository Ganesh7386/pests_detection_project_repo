...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 1, "aphids")
        self.add_class("object", 2, "army_worm")
        ...
        dataset_dir = os.path.join(dataset_dir1, subset)
        ...
        annotations1 = json.load(open(os.path.join(dataset_dir1, '/train/coco_aphids_armyworm_annotated.json')))
        ...
        for a in annotations:
            ...
            '''name_dict = {"Apple_Black_Rot": 1, "Apple_Healthy": 2, "Apple_Rust": 3, "Apple_Scab": 4,
                         "Blueberry_Healthy": 5, "Corn_Common_Rust": 6, "Corn_Gray_Leaf_Spot": 7, "Corn_Healthy": 8,
                         "Grape_Black_Measles": 9, "Grape_Black_Rot": 10, "Grape_Healthy": 11,
                         "Peach_Bacterial_Spot": 12, "Peach_Healthy": 13, "Pepper_Bell_Bacterial_Spot": 14,
                         "Pepper_Bell_Healthy": 15, "Pepper_Early_Blight": 16, "Potato_Healthy": 17,
                         "Potato_Late_Blight": 18, "Rasberry_Healthy": 19, "Soybean_Healthy": 20,
                         "Strawberry_Leaf_Scroch": 21, "Strawberry_Healthy": 22, "Tomato_Bacterial_Spot": 23,
                         "Tomato_Early_Blight": 24, "Tomato_Healthy": 25, "Tomato_Late_Blight": 26,
                         "Tomato_Leaf_Spot": 27, "Tomato_Target_Spot": 28}'''
            name_dict = {"aphids" : 1 , "army_worm" : 2}
